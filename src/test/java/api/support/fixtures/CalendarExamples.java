...
public class CalendarExamples {
  ...
  public static final String CASE_START_DATE_MONTHS_AGO_AND_END_DATE_WED = "77777777-2f09-4bc9-8924-3734882d44a3";
  public static final String CASE_START_DATE_FRI_AND_END_DATE_NEXT_MONTHS = "88888888-2f09-4bc9-8924-3734882d44a3";
  ...
  public static CalendarBuilder getCalendarById(String serviceId, MultiMap queries) {
    switch (serviceId) {
      ...
      case CASE_START_DATE_MONTHS_AGO_AND_END_DATE_THU:
        ZonedDateTime endDateThursday = ZonedDateTime
          .of(THURSDAY_DATE,LocalTime.MIDNIGHT, ZoneOffset.UTC);
        ZonedDateTime startDateThursday = endDateThursday.minusMonths(1);
        return new CalendarBuilder(CASE_START_DATE_MONTHS_AGO_AND_END_DATE_THU,
          startDateThursday, endDateThursday);

      case CASE_START_DATE_MONTHS_AGO_AND_END_DATE_WED:
        ZonedDateTime endDateWednesday = ZonedDateTime
          .of(WEDNESDAY_DATE, LocalTime.MIDNIGHT, ZoneOffset.UTC);
      ...
      case CASE_START_DATE_FRI_AND_END_DATE_NEXT_MONTHS:
        ZonedDateTime startDateFriday = ZonedDateTime
