...
public class ItemReportRepresentation {
  ...
  private void writeLastCheckIn(JsonObject itemReport, LastCheckIn lastCheckIn) {
    ...
    write(lastCheckInJson, "dateTime", formatDateTimeOptional(lastCheckIn.getDateTime()));
  ...
  private void writeRequest(Request request, JsonObject itemReport) {
    ...
    write(requestJson, "requestDate", formatDateTimeOptional(request.getRequestDate()));
    write(requestJson, "requestExpirationDate", formatDateTimeOptional(request.getRequestExpirationDate()));
  ...
  private void writeLoan(JsonObject itemReport, Loan loan) {
    ...
    write(loanJson, "checkInDateTime", formatDateTimeOptional(loan.getReturnDate()));
